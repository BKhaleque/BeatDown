...
public class GM : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        int[] timeline1 = { 1, 2, 3, 2, 2, 1, 1, 1, 2, 1, 1, 2, 3, 2, 2, 1, 1, 1, 2, 1, 1, 3, 1, 2, 2, 1, 1, 1, 2, 1, 1, 3, 1, 2, 2, 1, 1, 1, 2, 1, 4, 1, 3, 2, 2, 4 };
        PlayerPrefsX.SetIntArray("timeline1", timeline1);
        int[] timeline2 = { 3, 3, 4, 2, 2, 1, 1, 1, 2, 1, 1, 3, 4, 2, 2, 1, 1, 1, 2, 1, 1, 3, 4, 2, 2, 1, 1, 1, 2, 1, 1, 3, 4, 2, 2, 1, 1, 1, 2, 1, 4, 1, 3, 2, 2, 4 };
        PlayerPrefsX.SetIntArray("timeline2", timeline2);
        int[] timeline3 = { 1, 3, 1, 2, 2, 1, 1, 1, 2, 1, 1, 3, 1, 2, 2, 1, 1, 1, 2, 1, 4, 1, 3, 2, 2, 4, 1, 2, 2, 1, 4, 1, 3, 2, 2, 4, 1, 2, 2, 1, 4, 1, 3, 2, 2, 4 };
        PlayerPrefsX.SetIntArray("timeline3", timeline3);
        int[] timeline4 = { 4, 1, 3, 2, 2, 4, 1, 2, 2, 1, 4, 1, 3, 2, 2, 4, 1, 2, 2, 1, 1, 2, 3, 2, 2, 1, 1, 1, 2, 1, 1, 2, 3, 2, 2, 1, 1, 1, 2, 1, 4, 1, 3, 2, 2, 4 };
